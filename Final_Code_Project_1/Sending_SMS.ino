...
const char* ssid = "AndroidAPa3c0";
const char* password = "hqae7752";

const char* account_sid = "AC42949873e9e3ed5372368803a1913795";
const char* auth_token = "a1eefb6638f7fb7005b34ea66d3bd820";
String from_number      = "+19513361659";
String to_number        = "+19514897587";
String message_body     = "Call an Ambulance! But not for me!";
